...
import { checkForUpdate, type FetchLatestRelease } from "../index.ts";

const fakeFetch =
  (tag_name: string, html_url = "https://example.com/release"): FetchLatestRelease =>
  () =>
    Promise.resolve({ tag_name, html_url });
